...
[![Status](https://img.shields.io/badge/status-phase%200-9a6700)](docs/plan-fft.md)
...
> Status: **Phase 0** — a correct pure-Go FFT (radix-2 Cooley–Tukey for
> power-of-two lengths, Bluestein's chirp-z for arbitrary lengths). See
...
Empty input returns an empty slice; length 1 returns a copy.
